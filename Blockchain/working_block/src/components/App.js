...
// string memory name1, uint cost1, string memory procedure1, uint hId1, string memory docName1, bool treat1 
  ...
  createPatient(name, cost, procedure, hospId, docName, treated) {
    console.log("Adding")
    // this.setState({ loading: true })
    // let a = this.state.container.methods.createPatient("name", 666666, "procedure", 1, "docName", false )
    this.state.container.methods.createPatient(name, cost, procedure, hospId, docName, treated).send({ from: this.state.account })
